#ifndef CPU_ATTN_LSX_HPP
#define CPU_ATTN_LSX_HPP

#if !defined(__loongarch_sx)
  #error "cpu_attn_lsx.hpp requires -mlsx or -mlasx"
#endif
...
class AttentionImpl<ISA::LSX, scalar_t, head_dim, kv_cache_scalar_t> {
 public:
  ...
  constexpr static ISA ISAType = ISA::LSX;
